  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="templateId" label="模块ID" />
        <el-table-column prop="filePath" label="文件路径" />
        <el-table-column prop="port" label="结果端口" />
        <el-table-column prop="rootPackage" label="结果包名" />
        <el-table-column prop="deployUrl" label="域名" />
        <el-table-column prop="deployPath" label="输出目录" />
        <el-table-column prop="gitPath" label="git目录" />
        <el-table-column prop="gitGroup" label="git命名空间" />
        <el-table-column v-if="checkPer(['admin','component:edit','component:del'])" label="操作" width="200px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
