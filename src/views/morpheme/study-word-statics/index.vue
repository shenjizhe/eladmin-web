  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','studyWordStatics:edit','studyWordStatics:del'])" label="操作" width="150px" align="center">
...
<script>
import crudStudyWordStatics from '@/api/studyWordStatics'
...
export default {
  ...
  cruds() {
    return CRUD({ title: '学习单词统计', url: 'api/studyWordStatics', idField: 'id', sort: 'id,desc', crudMethod: { ...crudStudyWordStatics }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'studyWordStatics:add'],
        edit: ['admin', 'studyWordStatics:edit'],
        del: ['admin', 'studyWordStatics:del']
      },
      rules: {
        uid: [
