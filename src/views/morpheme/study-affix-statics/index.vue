    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="600px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="最后一次学习结果" prop="lastReviewResult">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="lastReviewResult" label="最后一次学习结果" />
        <el-table-column prop="memeryLevel" label="记忆等级" />
        <el-table-column v-if="checkPer(['admin','studyAffixStatic:edit','studyAffixStatic:del'])" label="操作" width="150px" align="center">
...
<script>
import crudStudyAffixStatic from '@/api/studyAffixStatic'
...
const defaultForm = { id: null, uid: null, objectId: null, studyTimes: null, simpleTimes: null, confuseTimes: null, forgetTimes: null, lastReviewTime: null, lastReviewResult: null, memeryLevel: null }
export default {
  name: 'StudyAffixStatic',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '学习词缀统计', url: 'api/studyAffixStatic', idField: 'id', sort: 'id,desc', crudMethod: { ...crudStudyAffixStatic }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'studyAffixStatic:add'],
        edit: ['admin', 'studyAffixStatic:edit'],
        del: ['admin', 'studyAffixStatic:del']
      },
      rules: {
        id: [
        ...
        lastReviewResult: [
          { required: true, message: '最后一次学习结果不能为空', trigger: 'blur' }
        ],
        memeryLevel: [
