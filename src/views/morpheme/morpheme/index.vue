  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <label class="el-form-item-label">词素类型</label>
        <el-input v-model="query.type" clearable placeholder="词素类型" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <label class="el-form-item-label">词源</label>
        <el-input v-model="query.source" clearable placeholder="词源" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="600px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="词素文本" prop="text">
            <el-input v-model="form.text" style="width: 95%;" />
          </el-form-item>
          <el-form-item label="词素类型" prop="type">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="text" label="词素文本" />
        <el-table-column prop="type" label="词素类型">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        type: [
          { required: true, message: '词素类型不能为空', trigger: 'blur' }
        ],
        source: [
      ...
      queryTypeOptions: [
        ...
        { key: 'type', display_name: '词素类型' },
        { key: 'source', display_name: '词源' }
      ]
